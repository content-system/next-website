      ...
      <div className="main-body">
        ...
        <ul className="row list">
          <li className="col s12 l6 img-card">
            ...
            <h3 className="sub highlight">FPT Media & Entertainment</h3>
          ...
          <li className="col s12 l6 img-card">
            ...
            <h3 className="sub highlight">FPT Healthcare</h3>
          ...
          <li className="col s12 l6 img-card">
            ...
            <h3 className="sub highlight">FPT Automotive</h3>
          ...
          <li className="col s12 l6 img-card">
            ...
            <h3 className="sub highlight">FPT Logistics</h3>
          ...
          <li className="col s12 l6 img-card">
            ...
            <h3 className="sub highlight">FPT Banking, Financial Services & Insurance</h3>
          ...
          <li className="col s12 l6 img-card">
            ...
            <h3 className="sub highlight">FPT Manufacturing</h3>
